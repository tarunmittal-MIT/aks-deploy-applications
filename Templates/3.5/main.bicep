...
// Increment the integer if deploying in quick succession to avoid conflicts due to keyvault soft delete, or manually purge the soft-deleted vaults 
var uniqueSuffix = uniqueString(resourceGroup().id, '1')
...
resource deploymentScript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    azCliVersion:  '2.9.1'
    scriptContent: '''
    RG=rg-use-azure-key-vault-with-aks
